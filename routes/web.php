...
Route::group(['prefix'=>'admin','middleware'=>'admin'],function(){
	...
	Route::group(['prefix'=>'category'],function(){
		...
		Route::post('edit/{id}/{cid}','c_category@postedit');
	...
	Route::group(['prefix'=>'ajax'],function(){
		Route::get('sort_by_en/{id}','c_ajax@sort_by_en'); // category
		Route::get('sort_by_vi/{id}','c_ajax@sort_by_vi'); // category
		Route::get('sort_by_jp/{id}','c_ajax@sort_by_jp'); // category
