    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card shadow mb-4">
            ...
            <div class="tab-content overflow">
                <div class="tab-pane active" id="anh">
                    ...
                    <table class="table">
                        <form method="post" action="admin/category/delete_all"><input type="hidden" name="_token" value="{{csrf_token()}}" />
                            ...
                            <tbody>
                                <?php dequycategory ($category_en,0,$str='',old('parent_id')); ?>  
                            </tbody>
                        </form>
                    </table>
                    @endif
                </div>
                <div class="tab-pane" id="viet">
                    @if(count($category_vi) > 0)
                    <table class="table">
                        <form method="post" action="admin/category/delete_all"><input type="hidden" name="_token" value="{{csrf_token()}}" />
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php dequycategory ($category_vi,0,$str='',old('parent_id')); ?>  
                            </tbody>
                        </form>
                    </table>
                    @endif
                </div>
                <div class="tab-pane" id="nhat">
                    @if(count($category_jp) > 0)
                    <table class="table">
                        <form method="post" action="admin/category/delete_all"><input type="hidden" name="_token" value="{{csrf_token()}}" />
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php dequycategory ($category_jp,0,$str='',old('parent_id')); ?>  
                            </tbody>
                        </form>
                    </table>
                    @endif
                ...
                ?>
                    <tr id="category" style="border-bottom: 1px solid #f3f6f9;">
                        ...
                        <td>
                            ...
                            <a class="dell" href="admin/category/delete/{{$val->category->id}}"><i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
                <?php
