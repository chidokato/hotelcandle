...
<form id="validateForm" action="admin/category/edit/{{ $data->id }}/{{ $data->category_id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input value="{{ isset($data) ? $data->slug : '' }}" name="slug" placeholder="..." type="text" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select id="parent_en" name='parent' class="form-control">
                                ...
                                <?php addeditcat ($category_translations,0,$str='',$data['parent']); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>View</label>
                            <input name="view" value="{{$data->view}}" placeholder="..." type="text" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <ul class="nav nav-pills">
                    <li><a data-toggle="tab" class="nav-link active" href="#anh">Sửa thông tin</a></li>
                </ul>
            </div>
            ...
            <div class="card-body">
                <div class="file-upload">
                    <div class="file-upload-content" onclick="$('.file-upload-input').trigger( 'click' )">
                        <img class="file-upload-image" src="{{ isset($data) ? 'data/category/'.$data->category->img : 'data/no_image.jpg' }}" />
                    </div>
    ...
    function addeditcat ($data, $parent=0, $str='',$select=0)
    {
        foreach ($data as $value) {
            if ($value['parent'] == $parent) {
                ...
                { ?>
                    <option value="<?php echo $value['category_id']; ?>" selected> <?php echo $str.$value['name']; ?> </option>
                <?php } else { ?>
                    <option value="<?php echo $value['category_id']; ?>" > <?php echo $str.$value['name']; ?> </option>
                <?php }
