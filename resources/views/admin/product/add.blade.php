...
<?php use App\section; ?>
<form id="validateForm" action="admin/product/add" method="POST" enctype="multipart/form-data" id="target">
        ...
        <div class="card shadow mb-4">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <ul class="nav nav-pills">
                    <li><a data-toggle="tab" class="nav-link active" href="#anh">Tiếng Anh <span class="red">*</span></a></li>
            ...
            <div class="card-body">
                <div class="form-group" style="position: relative;">
                    ...
                    <select name='category_id' class="form-control select2">
                        ...
                        @if(isset($data))
                        <?php addeditcat ($category_translations,0, $str='',$data['category_id']) ?>
                        @else
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="checkboxes__item">
                              <label class="checkbox style-e">
                                <input type="checkbox" name="breakfast" checked="checked"/>
                                <div class="checkbox__checkmark"></div>
                    ...
                    <div class="checkboxes__item">
                      <label class="checkbox style-e">
                        <input type="checkbox" name="gym" checked="checked"/>
                        <div class="checkbox__checkmark"></div>
                    ...
                    <div class="checkboxes__item">
                      <label class="checkbox style-e">
                        <input type="checkbox" name="safe" checked="checked"/>
                        <div class="checkbox__checkmark"></div>
                    ...
                    <div class="checkboxes__item">
                      <label class="checkbox style-e">
                        <input type="checkbox" name="desk" checked="checked"/>
                        <div class="checkbox__checkmark"></div>
                    ...
                    <div class="checkboxes__item">
                      <label class="checkbox style-e">
                        <input type="checkbox" name="spa" checked="checked"/>
                        <div class="checkbox__checkmark"></div>
                    ...
                    <div class="checkboxes__item">
                      <label class="checkbox style-e">
                        <input type="checkbox" name="tivi" checked="checked"/>
                        <div class="checkbox__checkmark"></div>
