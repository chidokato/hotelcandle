...
<?php use App\section; ?>
<form id="validateForm" action="admin/news/edit/{{$data->id}}" method="POST" enctype="multipart/form-data" id="target">
            ...
            <div class="card-body">
                <div class="file-upload">
                    <div class="file-upload-content" onclick="$('.file-upload-input').trigger( 'click' )">
                        <img class="file-upload-image" src="data/news/{{$data->articles->img}}" />
