...
<div class="d-sm-flex align-items-center justify-content-between mb-3 flex">
    <h2 class="h3 mb-0 text-gray-800 line-1 size-1-3-rem">Danh sách bài viết</h2>
                            ...
                            @foreach($articles as $article)
                                ...
                                <tr id="articles">
                                    ...
                                    <td class="thumbnail-img">
                                        {!! isset($val->articles->img) ? '<img data-action="zoom" src="data/news/'.$val->articles->img.'" />' : '' !!}
                                    </td>
                                    <td>
                                        <a class="line-1" href="admin/news/edit/{{$val->id}}" class="mr-2">[{{$val->locale}}] {{$val->name}}</a>
                                    </td>
                                    ...
                                    <td rowspan="3">
                                        <a title="xóa" class="dell" href="admin/news/delete/{{$val->articles->id}}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                    @endif
                                </tr>
                                @endforeach
