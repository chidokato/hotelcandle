$(document).ready(function(){
    $("a.dell").click(function(e){
        if(!confirm('Bạn có chắc muốn xóa bản ghi ?')){
            e.preventDefault();
            return false;
        }
        return true;
...
$(document).ready(function(){
    $("#sort_by").change(function(){
        ...
        $.get("admin/ajax/sort_by_en/"+sort_by,function(data){$("#parent_en").html(data);});
        $.get("admin/ajax/sort_by_vi/"+sort_by,function(data){$("#parent_vi").html(data);});
        $.get("admin/ajax/sort_by_jp/"+sort_by,function(data){$("#parent_jp").html(data);});
    });
});
