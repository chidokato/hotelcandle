...
{   
    // category
    public function sort_by_en($id)
    {
        $data = category_translations::where('locale','en')->where('sort_by',$id)->get();
        return view('admin.category.listparent',['data'=>$data]);
    }
    public function sort_by_vi($id)
    {
        $data = category_translations::where('locale','vi')->where('sort_by',$id)->get();
        return view('admin.category.listparent',['data'=>$data]);
    }
    public function sort_by_jp($id)
    {
        $data = category_translations::where('locale','jp')->where('sort_by',$id)->get();
        return view('admin.category.listparent',['data'=>$data]);
    }
